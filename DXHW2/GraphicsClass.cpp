...
void GraphicsClass::SetBackColor(int input)
{
	switch (input)
	{
	case 'R':
		m_BackColor = { 1.0f, 0.0f, 0.0f, 1.0f };
		break;
	case 'G':
		m_BackColor = { 0.0f, 1.0f, 0.0f, 1.0f };
		break;
	case 'B':
...
{
	// 씬을 그리기 위해 버퍼를 지웁니다
	m_Direct3D->BeginScene(m_BackColor.x, m_BackColor.y, m_BackColor.z, m_BackColor.w);
